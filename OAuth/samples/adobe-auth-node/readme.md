...
You can find a companion repo for this developer guide [on GitHub](https://github.com/adobeio/adobeio-documentation/tree/stage/auth/OAuth2.0Endpoints/samples/adobe-auth-node).
